...
<body>
<form method="post" action="boardReplyAction.do" 
	name="boardReplyForm" id="replyForm">
    ...
    <table>
    	<tr align="center">
				<td colspan="2"><h2>게시판 글 등록</h2></td>
		</tr>
        <tr>
            <th class="th_left">글쓴이</th>
			<td class="td_right"><input type="text" name="board_name" size="53"></td>
		</tr>
        <tr>
		...
		<tr>
			...
			<td class="td_right"><input type="text" name="board_subject" size="53"></td>
		</tr>
		<tr>
			<th class="th_left">내용</th>
			<td><textarea name="board_content" rows="15" cols="55"></textarea></td>
		</tr>
		<tr align="center">
				<td colspan="2">
